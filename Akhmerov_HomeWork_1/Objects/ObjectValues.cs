namespace Akhmerov_HomeWork_1.Objects
{
    ...
    using GameForm;
    using Controlable;
    using static ObjectCreator.AddSpaceObjects;
    using static ObjectCreator.AddShipObjects;
    using static ObjectCreator.AddInterfaceObject;
    ...
    internal static class ObjectValues
    {
        ...
        {
            public static readonly BaseObject ship = CreateShip();

            public static readonly BaseObject engineFire = CreateEngineFire();
            ...
            public static readonly BaseObject forceField = CreateForceField();
            ...
            public static readonly BaseObject forceFieldCharge = CreateForceFieldCharge();
            ...
            public static void BatteryTimerEvent()
            {
                ...
                if (batterySpawn) { batteries.Add(CreateBattery()); }
            ...
            public static void DisplayAvailableShots()
            {
                ...
                {
                    availabelBullets.Add(CreateDisplayBullet(availabelBullets));
                }
            }
